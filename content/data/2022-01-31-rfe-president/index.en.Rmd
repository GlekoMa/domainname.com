...
<META name="keywords" content="American, presidents, U.S., United States">
<META name="description" content="Illustrations from the holdings of the Library of Congress Prints and Photographs Division on the subject of U.S. Presidents, First Ladies, and Vice Presidents">
...
<table width="760" border="0" cellspacing="0" cellpadding="0">
  <tr valign="top">
    <td height="25" colspan="2" bgcolor="#663366"><a href="#content" name="top"></a> &nbsp;<a href="//www.loc.gov/" class="white">The
        Library of Congress</a> <span class="white-text">&gt;&gt;</span> <a href="//www.loc.gov/rr/" class="white">Researchers</a></td>
  </tr>
  <!-- spacer row -->
  <tr bgcolor="#EEEEEE">
   ...
   <form style="margin-bottom:0;" name="seek" method="GET" action="http://search.loc.gov:8765/query.html">
              <table cellpadding="4" cellspacing="0" border="0" bgcolor="#DDDDDD">
                <tr>
                  <td height="32" align="right"><label for="find">Find</label>
                  </td>
                  <td><input type=hidden name="col" value="loc">
                      <input type="text" name="qt" size="15" maxlength="255" style="font-family: monospace; font-size: 12px" value="" tabindex="1" id="find">
                  </td>
                  <td><label for="in">in</label>
                  </td>
                  <td><span class="drop-box">
                    <select name="qp" size="1" tabindex="2" id="in">
                        <option value="url:/rr/print/list/" selected>Image Lists</option>
  ...
  <tr>
    <td colspan="2">
      <!-- begin content table -->
      <a name="content"></a>      <table width="680" border="0" cellpadding="6" cellspacing="6">
        <tr valign="top">
...
<table bgcolor="#eeeeee" width="100%" cellpadding=5 cellspacing=0 border=0>
  <tr align=center>
...
<table bgcolor="#eeeeee" width="100%" cellpadding=8 cellspacing=0 border=0>
  <tr align=center>
...
<!-- #EndLibraryItem --><!-- #EndLibraryItem --><!-- InstanceEndEditable --></td>
 ...
 <form style="margin-bottom:0;" name="seek" method="GET" action="http://search.loc.gov:8765/query.html">
        <table cellpadding="4" cellspacing="0" border="0" bgcolor="#DDDDDD">
          <tr>
            <td height="32" align="right"><label for="find2">Find</label></td>
            <td><input type=hidden name="col" value="loc">
                <input type="text" name="qt" size="15" maxlength="255" style="font-family: monospace; font-size: 12px" value="" tabindex="1" id="find2">
            </td>
            <td><label for="in2">in</label></td>
            <td><span class="drop-box">
              <select name="qp" size="1" tabindex="2" id="in2">
  ...
  <tr>
    <td colspan="2"><table width="760" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td width="37%" height="40" bgcolor="#663366">&nbsp; <a href="//www.loc.gov/" class="white">The
          Library of Congress</a> <span class="white-text">&gt;&gt;</span> <a href="//www.loc.gov/rr/" class="white">Researchers</a><br>
          <span class="white-text">&nbsp;
            <!-- #BeginDate format:Am1 -->December 21, 2020<!-- #EndDate -->
          </span></td>
        <td width="38%" align="center" bgcolor="#663366"><a href="//www.loc.gov/homepage/legal.html" class="white">Legal</a> <span class="white-text">|</span> <a href="//www.loc.gov/global/disclaim.html" class="white">External Link Disclaimer</a><br>
          <br></td>
        <td width="25%" height="40" align="right" bgcolor="#663366"><a href="//www.loc.gov/rr/askalib/ask-print.html" class="white">Contact
          Us: </a>&nbsp;<br>
          <a href="//www.loc.gov/rr/askalib/ask-print.html" class="white">Ask
            a Librarian</a>&nbsp;&nbsp;</td>
      </tr>
    </table></td>
  </tr>

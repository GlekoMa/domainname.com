...
模板文件``cumcm.tex``和范例图片``mit_logo.png``：

::: {.callout-note appearance="minimal"}
<i class="bi bi-journal-code"></i> [Download saikr.tex](_saikr.tex){download="saikr.tex"}
:::

::: {.callout-note appearance="minimal"}
<i class="bi bi-file-earmark-image"></i> [Download bb.pdf](_bb.pdf){download="bb.pdf"}
:::
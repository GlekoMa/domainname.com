...
::: {.callout-note appearance="minimal"}
<i class="bi bi-journal-code"></i> [Download Jupyter-Demo](_Jupyter-Demo.ipynb){download="Jupyter-Demo"}
:::

::: {.callout-note appearance="minimal"}
<i class="bi bi-journal-code"></i> [Download RStudio-Demo](_RStudio-Demo.qmd){download="RStudio-Demo"}
:::
